		...
		groups: {
            alloy: {
                ...
                modules: {
						...
						'aui-datatable': {submodules: {'aui-datatable-selection': {skinnable:true, requires:['datatable-base']}, 'aui-datatable-edit': {skinnable:true, requires:['datatable-base','aui-calendar','aui-toolbar','aui-form-validator','overlay','sortable']} }, use:['aui-datatable-edit','aui-datatable-selection'], skinnable:true},
